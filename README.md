# MaLT: a tool for machine learning research
...
You can specify a set of arguments for `plot.py` in the yaml file and give it an alias you can pass in to `mode` argument.
